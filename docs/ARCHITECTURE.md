# Architecture cible — OpenDiag PSA
...
La V0.5 implémente les deux premiers niveaux et prépare un effacement DTC de niveau 3
avec plusieurs verrous explicites. Le reste des niveaux 3 et 4 ne doit jamais être
