...
export const vehicleSensorCandidates: VehicleSensorCandidate[] = [
  ...
  { id: "can-parking-brake", label: "Frein de stationnement", system: "Habitacle", description: "État 0x3AD validé : relâché, serré, transition et actionneur en mouvement.", source: "can", liveFields: ["parking_brake", "parking_brake_state"], priority: 1 },
