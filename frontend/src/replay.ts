...
export const replayGaugeCatalog: ReplayGaugeDefinition[] = [
  ...
  { key: "odometer_km", label: "Kilométrage total", unit: "km", minimum: 0, maximum: 300000, precision: 0, color: "#89d7ff", note: "Kilométrage absolu du BSI (0x552), validé sur véhicule et recoupé avec la documentation constructeur PSA." },
  ...
  { key: "fuel_system_status_raw", label: "État boucles carburant", unit: "code", minimum: 0, maximum: 65535, color: "#f2cc60", note: "États EOBD 01/03 des circuits carburant 1 et 2; conserve le mot encodé brut." },
  { key: "secondary_air_status_raw", label: "Injection d'air secondaire", unit: "code", minimum: 0, maximum: 255, color: "#72c6ff", note: "État EOBD 01/12 si le véhicule possède ce système." },
  { key: "oxygen_sensors_present_raw", label: "Sondes lambda présentes", unit: "bitmap", minimum: 0, maximum: 255, color: "#72c6ff", note: "Bitmap EOBD 01/13 des emplacements de sondes annoncés." },
  { key: "obd_standard_raw", label: "Norme OBD déclarée", unit: "code", minimum: 0, maximum: 255, color: "#89d7ff", note: "Code de conformité EOBD 01/1C." },
  { key: "catalyst_temperature_b1s1_c", label: "Température catalyseur B1S1", unit: "°C", minimum: -40, maximum: 1000, precision: 1, color: "#ff8d72", note: "Température normalisée EOBD 01/3C si exposée par l'ECU." },
  { key: "monitor_status_current_cycle_raw", label: "Moniteurs OBD · cycle courant", unit: "bitmap", minimum: 0, maximum: 4294967295, color: "#89d7ff", note: "Bitmap EOBD 01/41; le détail des tests reste dans la valeur brute." },
  { key: "accelerator_tertiary_pct", label: "Accélérateur · voie F", unit: "%", minimum: 0, maximum: 100, precision: 1, color: "#8ce9b4", note: "Troisième voie normalisée EOBD 01/4B lorsqu'elle existe." },
  { key: "maximum_maf_g_s", label: "Débitmètre · maximum déclaré", unit: "g/s", minimum: 0, maximum: 2550, color: "#72c6ff", note: "Première valeur maximale du PID EOBD 01/50." },
  { key: "ethanol_fuel_pct", label: "Teneur en éthanol", unit: "%", minimum: 0, maximum: 100, precision: 1, color: "#f2cc60", note: "PID EOBD 01/52 si un système flex-fuel est présent." },
  { key: "absolute_evap_vapor_pressure_kpa", label: "Pression absolue EVAP", unit: "kPa", minimum: 0, maximum: 328, precision: 2, color: "#b384ff", note: "Pression vapeurs canister EOBD 01/53." },
  { key: "evap_vapor_pressure_alt_pa", label: "Pression différentielle EVAP", unit: "Pa", minimum: -32767, maximum: 32768, color: "#b384ff", note: "Représentation alternative EOBD 01/54." },
  { key: "driver_demand_torque_pct", label: "Demande de couple conducteur", unit: "%", minimum: -125, maximum: 130, color: "#62e39a", note: "PID EOBD 01/61." },
  { key: "actual_engine_torque_pct", label: "Couple moteur réel", unit: "% réf.", minimum: -125, maximum: 130, color: "#ff8d72", note: "PID EOBD 01/62, à combiner au couple de référence 01/63." },
  { key: "engine_reference_torque_nm", label: "Couple moteur de référence", unit: "N·m", minimum: 0, maximum: 1000, color: "#ff8d72", note: "PID EOBD 01/63." },
  { key: "climate_pressure_kpa", label: "Pression climatisation", unit: "kPa", minimum: 100, maximum: 3100, precision: 0, color: "#63e6e2", note: "Pression du circuit réfrigérant (0x488 octet 7). Constant à 6375 kPa (octet brut 0xFF, hors plage) sur trois captures : probable sentinelle invalide, clim non sollicitée pendant ces trajets.", experimental: true },
  { key: "can_fuel_rate_lph", label: "Débit carburant CAN (0x488)", unit: "L/h", minimum: 0, maximum: 30, precision: 2, color: "#ffa45f", note: "Reconstruit depuis l'incrément du compteur de volume carburant 0x488, lissé sur 1,5 s. Disponible uniquement en replay, pas en direct.", experimental: true },
  { key: "can_instant_consumption_l_100km", label: "Consommation instantanée CAN", unit: "L/100km", minimum: 0, maximum: 25, precision: 1, color: "#ff8d72", note: "can_fuel_rate_lph rapporté à la vitesse ; non affiché sous 5 km/h (afficher le débit L/h à la place). Disponible uniquement en replay.", experimental: true },
  ...
  { key: "fiat_clock_day_candidate", label: "Fiat · jour", unit: "jour", minimum: 1, maximum: 31, color: "#89d7ff", note: "0x0C28A000 octet 2, BCD.", experimental: true },
  { key: "fiat_clock_month_candidate", label: "Fiat · mois", unit: "mois", minimum: 1, maximum: 12, color: "#89d7ff", note: "0x0C28A000 octet 3, BCD.", experimental: true },
  { key: "fiat_clock_year_candidate", label: "Fiat · année", unit: "année", minimum: 2000, maximum: 2099, color: "#89d7ff", note: "0x0C28A000 octets 4-5, BCD.", experimental: true },
  { key: "fiat_start_stop_state_raw", label: "Fiat · état Start&Stop brut", unit: "code", minimum: 0, maximum: 255, color: "#f2cc60", note: "0x0C1CA000 octet 2. Valeurs documentées : 0x28/2C indisponible, 0xC8/CC disponible mais OFF, 0xE8/EC ON.", experimental: true },
  { key: "fiat_start_stop_active_candidate", label: "Fiat · Start&Stop activé", unit: "état", minimum: 0, maximum: 1, color: "#62e39a", note: "0x0C1CA000 octet 2 bit 5, source Fiat 500C 1.2 S&S.", status: true, experimental: true },
  { key: "fiat_start_stop_available_candidate", label: "Fiat · Start&Stop disponible", unit: "état", minimum: 0, maximum: 1, color: "#f2cc60", note: "0x0C1CA000 octet 2 bits 6-7. À confronter aux conditions batterie/température du manuel.", status: true, experimental: true },
  { key: "fiat_start_stop_door_or_seatbelt_ok_candidate", label: "Fiat · condition porte/ceinture S&S", unit: "état", minimum: 0, maximum: 1, color: "#f2cc60", note: "0x0C1CA000 octet 2 bit 2 : portes avant fermées ou ceinture engagée selon la source; ce bit seul n'autorise pas l'arrêt.", status: true, experimental: true },
  { key: "fiat_clutch_pedal_candidate", label: "Fiat · pédale d'embrayage", unit: "état", minimum: 0, maximum: 1, color: "#62e39a", note: "0x0628A001 octet 5 bit 5 (0x20). Corrige l'ancien décodage 0x10, qui signifie accélération avec embrayage suffisamment relâché.", status: true, experimental: true },
  { key: "fiat_accelerator_request_candidate", label: "Fiat · demande accélérateur", unit: "état", minimum: 0, maximum: 1, color: "#8ce9b4", note: "0x0628A001 octet 5 bit 4 (0x10), combiné à l'état d'embrayage.", status: true, experimental: true },
  { key: "fiat_clutch_accelerator_state_raw", label: "Fiat · état embrayage/accélérateur", unit: "code", minimum: 0, maximum: 48, color: "#8ce9b4", note: "0x00 relâché; 0x10 accélération embrayée; 0x20 embrayage enfoncé; 0x30 accélération avec embrayage trop enfoncé.", experimental: true },
  ...
  { key: "fiat_contact_on_candidate", label: "Fiat · contact établi", unit: "état", minimum: 0, maximum: 1, color: "#b384ff", note: "0x0A18A000 octet 2 bit 6.", status: true, experimental: true },
  { key: "fiat_ignition_active_candidate", label: "Fiat · phase démarrage", unit: "état", minimum: 0, maximum: 1, color: "#ff8d72", note: "0x0A18A000 octet 2 bit 7; libellé communautaire « ignition », à valider pendant un vrai démarrage.", status: true, experimental: true },
  { key: "fiat_city_mode_candidate", label: "Fiat · mode City", unit: "état", minimum: 0, maximum: 1, color: "#89d7ff", note: "0x0A18A000 octet 4 bit 3.", status: true, experimental: true },
  { key: "fiat_rear_window_heater_candidate", label: "Fiat · dégivrage arrière", unit: "état", minimum: 0, maximum: 1, color: "#89d7ff", note: "0x0A18A000 octet 6 bit 4.", status: true, experimental: true },
  { key: "fiat_engine_running_candidate", label: "Fiat · moteur en marche", unit: "état", minimum: 0, maximum: 1, color: "#ff8d72", note: "0x0A18A006 octet 0 : 0 arrêté, 1 en marche selon la source communautaire.", status: true, experimental: true },
  { key: "fiat_speed_0a18a006_candidate_kph", label: "Fiat · vitesse redondante A18", unit: "km/h", minimum: 0, maximum: 200, precision: 1, color: "#59a8ff", note: "0x0A18A006 octets 2-3 ÷ 16. À comparer aux quatre roues lors d'une capture roulante.", experimental: true },
  { key: "fiat_speed_0a28a000_candidate_kph", label: "Fiat · vitesse redondante A28", unit: "km/h", minimum: 0, maximum: 200, precision: 1, color: "#59a8ff", note: "0x0A28A000 octets 0-1 ÷ 16. À comparer aux quatre roues lors d'une capture roulante.", experimental: true },
  { key: "fiat_electrical_load_candidate_raw", label: "Fiat · charge électrique brute", unit: "brut", minimum: 0, maximum: 65535, color: "#f2cc60", note: "0x0A18A001 octets 4-5. La source observe une hausse avec les consommateurs électriques; pas encore d'unité physique.", experimental: true },
...
export function passiveSnapshotToReplaySample(snapshot: PassiveSensorSnapshot): { point: ReplaySample; availableFields: string[] } {
  ...
  const point: ReplaySample = {
    ...
    fiat_start_stop_state_raw: integer("FIAT_BODY.START_STOP_STATE_RAW"),
    fiat_start_stop_active_candidate: logical("FIAT_BODY.START_STOP_ACTIVE"),
    fiat_start_stop_available_candidate: logical("FIAT_BODY.START_STOP_AVAILABLE"),
    fiat_start_stop_door_or_seatbelt_ok_candidate: logical("FIAT_BODY.START_STOP_DOOR_OR_SEATBELT_OK"),
    fiat_clutch_pedal_candidate: logical("FIAT_DRIVER.CLUTCH_PEDAL_PRESSED"),
    fiat_accelerator_request_candidate: logical("FIAT_DRIVER.ACCELERATOR_REQUEST_ACTIVE"),
    fiat_clutch_accelerator_state_raw: integer("FIAT_DRIVER.CLUTCH_ACCELERATOR_STATE_RAW"),
    fiat_contact_on_candidate: logical("FIAT_BODY.KEY_CONTACT_ON"),
    fiat_ignition_active_candidate: logical("FIAT_BODY.IGNITION_ACTIVE"),
    fiat_city_mode_candidate: logical("FIAT_BODY.CITY_MODE"),
    fiat_rear_window_heater_candidate: logical("FIAT_BODY.REAR_WINDOW_HEATER"),
    fiat_engine_running_candidate: logical("FIAT_ENGINE.ENGINE_RUNNING_CANDIDATE"),
    fiat_speed_related_raw_candidate: integer("FIAT_DYNAMICS.SPEED_RELATED_RAW"),
    fiat_speed_0a18a006_candidate_kph: numeric("FIAT_DYNAMICS.VEHICLE_SPEED_0A18A006"),
    fiat_speed_0a28a000_candidate_kph: numeric("FIAT_DYNAMICS.VEHICLE_SPEED_0A28A000"),
    fiat_speed_0a28a006_candidate_kph: numeric("FIAT_DYNAMICS.VEHICLE_SPEED_0A28A006"),
    fiat_wheel_activity_counter_raw: integer("FIAT_DYNAMICS.WHEEL_ACTIVITY_COUNTER_RAW") ?? integer("FIAT_DYNAMICS.WHEEL_ACTIVITY_COUNTER_0A28_RAW"),
    fiat_electrical_load_candidate_raw: integer("FIAT_ELECTRICAL.ELECTRICAL_LOAD_RAW"),
    ...
    fuel_system_status_raw: integer("OBD01.fuel_system_status"),
    secondary_air_status_raw: integer("OBD01.secondary_air_status"),
    oxygen_sensors_present_raw: integer("OBD01.oxygen_sensors_present"),
    obd_standard_raw: integer("OBD01.obd_standard"),
    catalyst_temperature_b1s1_c: numeric("OBD01.catalyst_temperature_b1s1"),
    monitor_status_current_cycle_raw: integer("OBD01.monitor_status_current_cycle"),
    ...
    accelerator_tertiary_pct: numeric("OBD01.accelerator_pedal_f"),
    ...
    driver_demand_torque_pct: numeric("OBD01.driver_demand_torque"),
    actual_engine_torque_pct: numeric("OBD01.actual_engine_torque"),
    engine_reference_torque_nm: numeric("OBD01.engine_reference_torque"),
    maximum_maf_g_s: numeric("OBD01.maximum_maf"),
    ethanol_fuel_pct: numeric("OBD01.ethanol_fuel_percent"),
    absolute_evap_vapor_pressure_kpa: numeric("OBD01.absolute_evap_vapor_pressure"),
    evap_vapor_pressure_alt_pa: numeric("OBD01.evap_vapor_pressure_alt"),
    emission_requirements_raw: integer("OBD01.emission_requirements"),
    idle_setpoint_rpm: numeric("Dat_CMM.P022_Com_nSetPLo"),
    odometer_km: numeric("DAT4_BSI_AEE2010.P015_Com_lTotDst"),
    climate_pressure_kpa: numeric("Dat_CMM.P056_ACCD_p"),
    ...
    // Débit/consommation dérivés du compteur 0x488 : calcul à fenêtre glissante
    // sur l'historique complet d'une session, disponible uniquement en replay.
    can_fuel_rate_lph: null,
    can_instant_consumption_l_100km: null,
    can_trip_fuel_l: null,
