...
class ReplaySample(BaseModel):
    ...
    rear_door_ajar_candidate: bool | None = None
    ...
    engine_rpm_3b8_candidate: float | None = None
    accelerator_pct_3b8_candidate: float | None = None
    accelerator_pct_2e8_candidate: float | None = None
    engine_state_57c_candidate_raw: int | None = None
    gear_torque_table_2e8_candidate_raw: int | None = None
