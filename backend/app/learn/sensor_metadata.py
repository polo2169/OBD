...
SENSOR_METADATA: dict[str, tuple[str, str, bool]] = {
    ...
    "Dat_BSI.PARKING_BRAKE": ("Frein de stationnement", "État source-confirmé dans 0x412, octet 0 masque 0x08; l'état actif n'a pas encore été observé sur cette 308.", True),
